PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.com.google.clientidbase=android-bestone \
    ro.com.google.gmsversion=8.1_201809.go \
    ro.config.alarm_alert=Argon.ogg \
    ro.config.default_message0=Hangouts.ogg \
    ro.config.default_message1=Hangouts.ogg \
    ro.config.default_message=Hangouts.ogg \
    ro.config.low_ram=true \
    ro.config.notification_sound=Hangouts.ogg \
    ro.config.ringtone0=Hangouts_call.ogg \
    ro.config.ringtone1=Hangouts_call.ogg \
    ro.config.ringtone=Hangouts_call.ogg \
    ro.control_privapp_permissions=log \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.keybox.id.value=Camf \
